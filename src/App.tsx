...
// INTEGRATION  (with real delta display + shareable card)
...
const Integration: React.FC<IntegrationProps> = ({
  ...
  // Simple heuristic: big stress drop = +2 levels, moderate = +1

  const exitLevel    = Math.min(7, entryLevel + (stressDelta <= -3 ? 2 : stressDelta < 0 ? 1 : 0));


  const ELI_LABELS: Record<number, string> = {

    1: "Victim", 2: "Conflict", 3: "Responsibility",

    4: "Concern", 5: "Opportunity", 6: "Synthesis", 7: "Creation",
      ...
      <div className="h-full flex flex-col px-4 text-center justify-center">
        ...
        <div className="flex-1 overflow-y-auto hide-scrollbar pb-20 pt-4">
          ...
          <div className="glass-panel p-8 rounded-[2rem] border-t-4 border-teal-500 shadow-2xl text-center mb-6 animate-enter">
            ...
            <div className="text-left mb-6 space-y-4">
              ...
              <div>
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <label className="text-[9px] uppercase tracking-widest text-white/40 font-bold">Post-Protocol Stress</label>
              ...
              <div>
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <label className="text-[9px] uppercase tracking-widest text-white/40 font-bold">Post-Protocol Energy</label>
            ...
            <div className="text-left bg-white/5 border border-white/10 p-6 rounded-2xl mb-6">

              {generating ? (

                <div className="flex items-center gap-2 text-white/40 text-sm"><Loader2 size={14} className="animate-spin" /> Synthesizing your decree...</div>
